...
function Get_Membership_stats()
{
    ...
    // General membership stats grouped by type
    $membership_stats = $wpdb->get_results("SELECT mitgliedschaft_art, COUNT(*) as count FROM $table_name GROUP BY mitgliedschaft_art", ARRAY_A);

    // New members and resignations by type for the current and previous years
